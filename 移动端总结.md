...
![enter image description here](http://images2015.cnblogs.com/blog/278431/201512/278431-20151201151950671-1854937785.png)
将网站添加到主屏幕快速启动方式，仅针对ios的safari顶端状态条的样式
...
```
[参考案例](%EF%BC%9Ahttp://action.weixin.qq.com/payact/readtemplate?t=mobile/2015/wxzfsht/index_tmpl)
### 常见问题
#### 移动端如何定义字体font-family
...
ios系统中元素被触摸时产生的半透明灰色遮罩怎么去掉
ios用户点击一个链接，会出现一个半透明灰色遮罩, 如果想要禁用，可设置`-webkit-tap-highlight-color`的alpha值为0，也就是属性值的最后一位设置为0就可以去除半透明灰色遮罩
...
[体验demo：](http://1.peunzhang.sinaapp.com/demo/btn/btn.html)
